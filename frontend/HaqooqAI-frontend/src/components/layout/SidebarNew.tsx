    ...
    <aside className="fixed left-0 top-0 z-40 flex h-full w-80 flex-col panel border-r hairline">
      ...
      <div className="px-4 pb-3">
        <button
          ...
          className="group flex w-full items-center justify-center gap-2 rounded-xl h-10 px-4 text-sm font-semibold text-white transition hover:opacity-95 shadow-md hover:shadow-lg"
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <MessageSquare
                          className={cn("w-4 h-4", active ? "text-white" : "text-slate-300")}
                        />
                      </div>
