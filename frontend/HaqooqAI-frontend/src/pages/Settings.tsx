                  ...
                  <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                    <div className="flex items-start gap-2">
                      ...
                      <div className="text-sm">
                        <p className="font-medium text-amber-800">Development Notice</p>
                        <p className="text-amber-700 mt-1">
                          We're currently updating our backend API response models. If you experience any issues saving API keys, 
                          the key may still be successfully stored despite error messages. We're working to resolve this soon.
                        </p>
                      </div>
                    </div>
                  </div>
